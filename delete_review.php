...
<div class="content">
    ...
    <div>
        ...
        <form action="delete_review2.php" method="post">
            <p>Delete the review of the following movie:</p>
            <select name="sel_movie" id='selected_pcid'">
            ...
            <p>
                <input type="submit" name="" value="Delete the review">
            </p>
        </form>

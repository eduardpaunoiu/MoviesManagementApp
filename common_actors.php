...
$sql = "SELECT nume_film FROM film
            WHERE id_film IN (SELECT id_film FROM filmactori WHERE id_actor IN 
                  	            (SELECT id_actor FROM actor WHERE id_actor IN
						            (SELECT id_actor FROM filmactori GROUP BY id_actor
...
<div class = "content">
    <h2>Numele filmelor cu actori comuni</h2>
    <table>
